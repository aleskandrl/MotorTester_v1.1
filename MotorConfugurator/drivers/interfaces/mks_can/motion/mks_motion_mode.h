...
public:
    ...
    [[nodiscard]] motion_core::Result<motion_core::MotionQueueStats> enqueue_motion_batch(
        const std::vector<motion_core::MotionCommandPoint>& points);
...
protected:
    [[nodiscard]] bool try_pop_setpoint(motion_core::MotionCommandPoint& point);
...
private:
    ...
    motion_core::MotionCommandPoint pending_point_{};
